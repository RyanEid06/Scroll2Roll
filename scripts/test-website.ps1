...
foreach ($required in @('play-money', 'Windows x64', 'Blackjack', 'European Roulette', 'Plinko', 'Coop Climb', 'Midnight Crossing', "No-Limit Hold'em", 'Privacy', 'Installation', 'Troubleshooting', 'Scroll2Roll-0.2.0-windows-x64.zip')) {
