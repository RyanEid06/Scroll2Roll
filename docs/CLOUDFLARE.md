...
- `download.html` presents the exact local post-art 0.3.1 Casino Freeze review-package byte
...
51,516,900-byte (49.13 MiB) post-art package is above that ceiling, so it is not
...
its exact 51,516,900-byte size and SHA-256
