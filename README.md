...
The version-0.1.0 master-plan baseline remains preserved, and version 0.2.0 passed local acceptance with six complete games. All five owner-approved 0.3.0 games are complete with exact integer math, deterministic settlement, full keyboard/mouse flows, privacy-safe projections, and save-v1/save-v2 migration to save-v3. The owner later rejected the native 0.3.0 visual presentation and mandated a full shell-plus-eleven-interior overhaul in `UI_OVERHAUL.md`. Its foundation and asset/component milestones now pass 44/44 tests in Debug and Release, with original ImageGen covers, licensed bundled Manrope, save-v4 theme/reduced-motion migration, and tested resource ownership. The old views remain visually unaccepted until their replacement milestones finish. Exact evidence is recorded in `docs/VALIDATION.md`. The untouched original Blackjack draft remains under `legacy/Blackjack-v1`.
